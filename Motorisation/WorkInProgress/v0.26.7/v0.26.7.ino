...
void parcoursDE(){
  ...
  avanceDeMmDecaleLigne(510, 0.75);  //  Décalé de Ligne !!

  delay(500);

  //Fonction si lumi alors cligno
  
  delay(500);
  
  avanceDeMmDecaleLigne(250, 0.75);   //Décalé de ligne !!
...
void parcoursFC(){
  ...
  avanceDeMmLigne(200, 1.50);
  avanceDeMmLigne(640, 2.00);
  avanceDeMmInterLigne(0.75);
  distempR = MDROIT.ttlTicks;
