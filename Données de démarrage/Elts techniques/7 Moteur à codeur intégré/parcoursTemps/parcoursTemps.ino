...
selon une base de temps uniquement (voir fonction isrt())
*/
/***********************************************************************************
 * 
...
void isrt() {
  ...
  // de 0 à 5 seconde je vais tout droit
  // de 5 à 7 seconde je tourne sur place
  // de 7 à 10 seconde je recule tout droit
  ...
  else if(etat == 1 && temps > 5) { // on stop net
    commandeDroit = -255;
    commandeGauche = -255;
    CommandeMoteurDroit(commandeDroit);
    CommandeMoteurGauche(commandeGauche);
  ...
  else if(etat == 2 && temps > 5) { // on tourne
    commandeDroit = 0;
    commandeGauche = 255;
    CommandeMoteurDroit(commandeDroit);
    CommandeMoteurGauche(commandeGauche);
  ...
  else if(etat == 3 && temps > 7) { // on stop net
    commandeDroit = 0;
    commandeGauche = -255;
    CommandeMoteurDroit(commandeDroit);
    CommandeMoteurGauche(commandeGauche);
  ...
  else if(etat == 4 && temps > 7) { // on recule plein pot
    commandeDroit = -255;
    commandeGauche = -255;
    CommandeMoteurDroit(commandeDroit);
    CommandeMoteurGauche(commandeGauche);
  ...
  else if(etat == 5 && temps > 10) { // on stop net
    commandeDroit = 255;
    commandeGauche = 255;
    CommandeMoteurDroit(commandeDroit);
    CommandeMoteurGauche(commandeGauche);
